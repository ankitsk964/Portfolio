    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip" id="home">
      ...
      <div className="container relative z-10">
        ...
        <div className="max-w-lg mx-auto">
          ...
          Yo, I&apos;m <span className="text-white font-semibold">Ankit Kumar</span> <span className="text-white font-semibold">,</span> web dev wiz & data geek. Let’s cook up something fire! 🔥
          </p>
        </div>
